  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/" aria-label="Home page">
            <div className="flex items-center justify-between">
                <Image src={seatplus} alt={'Seatplus Icon'} className='h-9 w-9' />
                <div className='hidden ml-2 font-display text-slate-900 dark:text-white tracking-tight text-3xl lg:block'>Seatplus</div>
            </div>
        </Link>
      </div>
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link href="https://github.com/seatplus/seatplus" className="group" aria-label="GitHub">
